...
export function HomeHero() {
    return (
        // AQUI AGREGAMOS 'bg-mapis-pattern' para la marca de agua
        <FadeIn direction="none" className="relative bg-mapis-blue bg-mapis-pattern text-white overflow-hidden">
            
            {/* Gradientes para asegurar legibilidad sobre el patrón */}
