...
import { BadgeCheck, Globe, Heart, Clock, MapPin } from "lucide-react"
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <FadeIn direction="left" className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl rotate-1 hover:rotate-0 transition-all duration-500 group">
                        <Image
            ...
            <section className="py-20 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Misión */}
                        <FadeIn delay={100} direction="up" className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow border-t-4 border-mapis-blue">
                        ...
                        {/* Visión */}
                        <FadeIn delay={200} direction="up" className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow border-t-4 border-mapis-yellow">
                        ...
                        {/* Valores */}
                        <FadeIn delay={300} direction="up" className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow border-t-4 border-green-500">
